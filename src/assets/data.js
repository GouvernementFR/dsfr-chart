export const chartData = {
  ...
  barLineChart: {
    default: {
      ...
      yBars: [
        [25.9, 36.4, 38, 23.1, 42.9],
        [22.9, 26.4, 45, 42, 31],
      ],
      yLines: [
        [3, 10, -12, -7, 11]
      ],
      nameLines: ['Taux de natalité', 'Taux de mortalité'],
      nameBars: ['Solde naturel'],
  ...
  areaLineChart: {
    default: {
      ...
      nameLines: ['Solde naturel'],
      unitTooltipArea: '',
      unitTooltipLine: '%',
      showLinesLabels: ['minmax', 'minmax'],
      singleAxis: true,
    },
  },
  scatterChart: {
