...
<template>
  ...
  >
    ...
    >
      <path
        class="FR-2A"
        :style="{ display: config.displayPath['FR-2A'] }"
      ...
      <path
        class="FR-2B"
        :style="{ display: config.displayPath['FR-2B'] }"
      ...
      <path
        class="FR-13"
        :style="{ display: config.displayPath['FR-13'] }"
      ...
      <path
        class="FR-84"
        :style="{ display: config.displayPath['FR-84'] }"
      ...
      <path
        class="FR-83"
        :style="{ display: config.displayPath['FR-83'] }"
      ...
      <path
        class="FR-04"
        :style="{ display: config.displayPath['FR-04'] }"
      ...
      <path
        class="FR-06"
        :style="{ display: config.displayPath['FR-06'] }"
      ...
      <path
        class="FR-05"
        :style="{ display: config.displayPath['FR-05'] }"
      ...
      <path
        class="FR-48"
        :style="{ display: config.displayPath['FR-48'] }"
      ...
      <path
        class="FR-03"
        :style="{ display: config.displayPath['FR-03'] }"
      ...
      <path
        class="FR-30"
        :style="{ display: config.displayPath['FR-30'] }"
      ...
      <path
        class="FR-11"
        :style="{ display: config.displayPath['FR-11'] }"
      ...
      <path
        class="FR-34"
        :style="{ display: config.displayPath['FR-34'] }"
      ...
      <path
        class="FR-66"
        :style="{ display: config.displayPath['FR-66'] }"
      ...
      <path
        class="FR-15"
        :style="{ display: config.displayPath['FR-15'] }"
      ...
      <path
        class="FR-43"
        :style="{ display: config.displayPath['FR-43'] }"
      ...
      <path
        class="FR-63"
        :style="{ display: config.displayPath['FR-63'] }"
      ...
      <path
        class="FR-65"
        :style="{ display: config.displayPath['FR-65'] }"
      ...
      <path
        class="FR-64"
        :style="{ display: config.displayPath['FR-64'] }"
      ...
      <path
        class="FR-40"
        :style="{ display: config.displayPath['FR-40'] }"
      ...
      <path
        class="FR-33"
        :style="{ display: config.displayPath['FR-33'] }"
      ...
      <path
        class="FR-24"
        :style="{ display: config.displayPath['FR-24'] }"
      ...
      <path
        class="FR-47"
        :style="{ display: config.displayPath['FR-47'] }"
      ...
      <path
        class="FR-46"
        :style="{ display: config.displayPath['FR-46'] }"
      ...
      <path
        class="FR-09"
        :style="{ display: config.displayPath['FR-09'] }"
      ...
      <path
        class="FR-32"
        :style="{ display: config.displayPath['FR-32'] }"
      ...
      <path
        class="FR-31"
        :style="{ display: config.displayPath['FR-31'] }"
      ...
      <path
        class="FR-82"
        :style="{ display: config.displayPath['FR-82'] }"
      ...
      <path
        class="FR-12"
        :style="{ display: config.displayPath['FR-12'] }"
      ...
      <path
        class="FR-81"
        :style="{ display: config.displayPath['FR-81'] }"
      ...
      <path
        class="FR-01"
        :style="{ display: config.displayPath['FR-01'] }"
      ...
      <path
        class="FR-38"
        :style="{ display: config.displayPath['FR-38'] }"
      ...
      <path
        class="FR-74"
        :style="{ display: config.displayPath['FR-74'] }"
      ...
      <path
        class="FR-42"
        :style="{ display: config.displayPath['FR-42'] }"
      ...
      <path
        class="FR-69"
        :style="{ display: config.displayPath['FR-69'] }"
      ...
      <path
        class="FR-73"
        :style="{ display: config.displayPath['FR-73'] }"
      ...
      <path
        class="FR-07"
        :style="{ display: config.displayPath['FR-07'] }"
      ...
      <path
        class="FR-26"
        :style="{ display: config.displayPath['FR-26'] }"
      ...
      <path
        class="FR-17"
        :style="{ display: config.displayPath['FR-17'] }"
      ...
      <path
        class="FR-19"
        :style="{ display: config.displayPath['FR-19'] }"
      ...
      <path
        class="FR-23"
        :style="{ display: config.displayPath['FR-23'] }"
      ...
      <path
        class="FR-87"
        :style="{ display: config.displayPath['FR-87'] }"
      ...
      <path
        class="FR-86"
        :style="{ display: config.displayPath['FR-86'] }"
      ...
      <path
        class="FR-16"
        :style="{ display: config.displayPath['FR-16'] }"
      ...
      <path
        class="FR-79"
        :style="{ display: config.displayPath['FR-79'] }"
      ...
      <path
        class="FR-22"
        :style="{ display: config.displayPath['FR-22'] }"
      ...
      <path
        class="FR-85"
        :style="{ display: config.displayPath['FR-85'] }"
      ...
      <path
        class="FR-50"
        :style="{ display: config.displayPath['FR-50'] }"
      ...
      <path
        class="FR-56"
        :style="{ display: config.displayPath['FR-56'] }"
      ...
      <path
        class="FR-29"
        :style="{ display: config.displayPath['FR-29'] }"
      ...
      <path
        class="FR-35"
        :style="{ display: config.displayPath['FR-35'] }"
      ...
      <path
        class="FR-44"
        :style="{ display: config.displayPath['FR-44'] }"
      ...
      <path
        class="FR-49"
        :style="{ display: config.displayPath['FR-49'] }"
      ...
      <path
        class="FR-72"
        :style="{ display: config.displayPath['FR-72'] }"
      ...
      <path
        class="FR-53"
        :style="{ display: config.displayPath['FR-53'] }"
      ...
      <path
        class="FR-14"
        :style="{ display: config.displayPath['FR-14'] }"
      ...
      <path
        class="FR-61"
        :style="{ display: config.displayPath['FR-61'] }"
      ...
      <path
        class="FR-28"
        :style="{ display: config.displayPath['FR-28'] }"
      ...
      <path
        class="FR-89"
        :style="{ display: config.displayPath['FR-89'] }"
      ...
      <path
        class="FR-70"
        :style="{ display: config.displayPath['FR-70'] }"
      ...
      <path
        class="FR-76"
        :style="{ display: config.displayPath['FR-76'] }"
      ...
      <path
        class="FR-27"
        :style="{ display: config.displayPath['FR-27'] }"
      ...
      <path
        class="FR-37"
        :style="{ display: config.displayPath['FR-37'] }"
      ...
      <path
        class="FR-45"
        :style="{ display: config.displayPath['FR-45'] }"
      ...
      <path
        class="FR-36"
        :style="{ display: config.displayPath['FR-36'] }"
      ...
      <path
        class="FR-41"
        :style="{ display: config.displayPath['FR-41'] }"
      ...
      <path
        class="FR-18"
        :style="{ display: config.displayPath['FR-18'] }"
      ...
      <path
        class="FR-21"
        :style="{ display: config.displayPath['FR-21'] }"
      ...
      <path
        class="FR-58"
        :style="{ display: config.displayPath['FR-58'] }"
      ...
      <path
        class="FR-71"
        :style="{ display: config.displayPath['FR-71'] }"
      ...
      <path
        class="FR-39"
        :style="{ display: config.displayPath['FR-39'] }"
      ...
      <path
        class="FR-51"
        :style="{ display: config.displayPath['FR-51'] }"
      ...
      <path
        class="FR-60"
        :style="{ display: config.displayPath['FR-60'] }"
      ...
      <path
        class="FR-62"
        :style="{ display: config.displayPath['FR-62'] }"
      ...
      <path
        class="FR-59"
        :style="{ display: config.displayPath['FR-59'] }"
      ...
      <path
        class="FR-02"
        :style="{ display: config.displayPath['FR-02'] }"
      ...
      <path
        class="FR-80"
        :style="{ display: config.displayPath['FR-80'] }"
      ...
      <path
        class="FR-08"
        :style="{ display: config.displayPath['FR-08'] }"
      ...
      <path
        class="FR-10"
        :style="{ display: config.displayPath['FR-10'] }"
      ...
      <path
        class="FR-52"
        :style="{ display: config.displayPath['FR-52'] }"
      ...
      <path
        class="FR-67"
        :style="{ display: config.displayPath['FR-67'] }"
      ...
      <path
        class="FR-54"
        :style="{ display: config.displayPath['FR-54'] }"
      ...
      <path
        class="FR-77"
        :style="{ display: config.displayPath['FR-77'] }"
      ...
      <path
        class="FR-68"
        :style="{ display: config.displayPath['FR-68'] }"
      ...
      <path
        class="FR-55"
        :style="{ display: config.displayPath['FR-55'] }"
      ...
      <path
        class="FR-57"
        :style="{ display: config.displayPath['FR-57'] }"
      ...
      <path
        class="FR-88"
        :style="{ display: config.displayPath['FR-88'] }"
      ...
      <path
        class="FR-91"
        :style="{ display: config.displayPath['FR-91'] }"
      ...
      <path
        class="FR-78"
        :style="{ display: config.displayPath['FR-78'] }"
      ...
      <path
        class="FR-95"
        :style="{ display: config.displayPath['FR-95'] }"
      ...
      <path
        class="FR-93"
        :style="{ display: config.displayPath['FR-93'] }"
      ...
      <path
        class="FR-75"
        :style="{ display: config.displayPath['FR-75'] }"
      ...
      <path
        class="FR-92"
        :style="{ display: config.displayPath['FR-92'] }"
      ...
      <path
        class="FR-94"
        :style="{ display: config.displayPath['FR-94'] }"
      ...
      <path
        class="FR-25"
        :style="{ display: config.displayPath['FR-25'] }"
      ...
      <path
        class="FR-90"
        :style="{ display: config.displayPath['FR-90'] }"
