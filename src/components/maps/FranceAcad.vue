...
<template>
    <svg version="1.1" :viewBox="props.viewBox" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g fill-rule="nonzero" stroke="#FFFFFF" stroke-width="4">
            <path fill="#6b6b6b" class="FR-09" :style="{display:props.displayDep['FR-09']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M529.125,126.425l-9-10.3l-2-6.6l-3.3-2.3l-12.4-2.8l-5,3.9l-3.1,0.1l-5.8-2.6l-0.2-0.1l-0.2-0.1l-3.6-3.1
            ...
            <path fill="#6b6b6b" class="FR-11" :style="{display:props.displayDep['FR-11']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M539.125,143.625l6.1,2.8l-1.9,2.8l2.6,1.8l1.6-2.8l3.2,0.5l4.9,3.7l-3.4,15l-2.5,2l-3.9-0.4l2.2,1.5
            ...
            <path fill="#6b6b6b" class="FR-15" :style="{display:props.displayDep['FR-15']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M407.925,55.425l-4.6-5.5l-6.8,1.2l-6.1-1.5l-2.5,2.3l-2.4-10.2l-6.1-1.5l-1.3-3l-3.2,2.4l-3.6-1.2
                ...
                "/>
            <path fill="#6b6b6b" class="FR-14" :style="{display:props.displayDep['FR-14']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M408.425,75.025l0.1-0.4l-17.6-4.7l-5.8,2l-2.6-1.9l-2.9,2.5l-14.2,0.7l-3.7-3l-9.6,2l-0.9-3.5l-2.7,1.9
            ...
            <path fill="#6b6b6b" class="FR-10" :style="{display:props.displayDep['FR-10']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M412.925,76.325l0.9,6.4l-1.5,3.9l1.5,3.5l-5.6,8.1l-3.1,0.3l0.3,16l-1.1,3.2l-6-2l-8.9,4.4l-1.4,3l3.6,9
            ...
            <path fill="#6b6b6b" class="FR-16" :style="{display:props.displayDep['FR-16']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M347.325,139.025l-7.7-1.1l0.3,2.3l-2,2.6l-0.1,0.1c-0.7,0.5-1.5,1-2.3,1.6c-1,0.7-2,1.4-3,2.1l-2.9-1.2
                ...
                z"/>
            <path fill="#6b6b6b" class="FR-18" :style="{display:props.displayDep['FR-18']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M339.925,140.225l-0.3-2.3l-12.2-7.2l-2.5,1.9l-10.3-2.5l-7.1,2l-6.3-1.2l-1.8-3.6l-4.5,10.6h-4.2
                ...
                L339.925,140.225z"/>
            <path fill="#6b6b6b" class="FR-17" :style="{display:props.displayDep['FR-17']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M335.625,149.925h-5.7v2.2l-2.3,1.6l-2.6,1.9c-0.3,0.2-0.5,0.3-0.8,0.6l-1.6,1h-4.4l-3,3.7l-0.1,0.1
            ...
            <path fill="#6b6b6b" class="FR-05" :style="{display:props.displayDep['FR-05']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M448.425,218.225l-3.3-0.4l0.4-3.2l-3-1.1l-0.6-3.1l-3.9-0.8v0.1l-4.3-0.6l-5.3,4.4l-6.9,1l-2.5,2.2
            ...
            <path fill="#6b6b6b" class="FR-04" :style="{display:props.displayDep['FR-04']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M470.125,237.325l3-1.9l2.3,3.5l0.2,3.5l-5.3,4.6l3,1.6l4.3,9.2l-1.3,1.4l-2,9.3l-7,7.6l-1.2,4.5l0.5,3.4
            ...
            <path fill="#6b6b6b" class="FR-07" :style="{display:props.displayDep['FR-07']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M358.225,227.725l1.7-2.7l-1.2-3.3l5.2-5.5l-0.5-6.5l-7.5-8.4l-12.6,3l-10.3-0.8l3-1.7l0.6-3l-4.7-4.8
                ...
                L358.225,227.725z"/>
            <path fill="#6b6b6b" class="FR-01" :style="{display:props.displayDep['FR-01']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M382.825,305.425l-4.8-4.2l-3.2,2l-7.2-0.2l-6.5-7.1l0,0h-4.5l-5.4,4.1l-9.5,3.3l-2.5,2.1l1.9,6l-1.9,2.7
            ...
            <path fill="#6b6b6b" class="FR-22" :style="{display:props.displayDep['FR-22']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M325.525,321.925L325.525,321.925l-5.5-0.2l-3.1,0.9l-14.8-3l-2.2,2.8l-12.8,1.2l-3.2,3.2l-1.9-2.7
            ...
            <path fill="#6b6b6b" class="FR-03" :style="{display:props.displayDep['FR-03']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M470.225,317.425h-0.1l-5.4-3.6l-6,1.4l-6.6-1.7l-6.6,23.5l-6.5-8.7l-1.8,2.6l-2.7-1.7l-2.6,1.9l-2.4-2
                ...
                L470.225,317.425z"/>
            <path fill="#6b6b6b" class="FR-02" :style="{display:props.displayDep['FR-02']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M459.325,375.125l-7.8,1.7l-2.8,2.8l2.1,2.8l-5,4.5l0,0l0.2,1.2v5l-5.6,3l-3.6,5.5l-3.9,0.8l-1,4.7v3.5
            ...
            <path fill="#6b6b6b" :style="{display:props.displayDep['FR-01']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M285.425,69.425l-0.2,0.3l-12.2,8.5l-24.8,6.2l-16,8.6l-6.5,14.2l1.9,2.5l9.9,2.2l0.3,0.1l-1.8,0.6v0.1
                ...
                />
            <path fill="#6b6b6b" class="FR-20" :style="{display:props.displayDep['FR-20']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M202.425,118.225l-14.1-1.5l-10.7-3.7l-5.8,2.5v0.1l-0.2,0.1l-7.2-12l2.7-8.7l-1.1-3.1l-7.3-0.8l-2.8,2
                ...
                l-5.4,4.7l-10.9,3L202.425,118.225z"/>
            <path fill="#6b6b6b" class="FR-06" :style="{display:props.displayDep['FR-06']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M165.325,171.525l-7.9,5.3l-3-1l-5.4-10.8h-0.2l-12.6,0.1l0.3-6.3l-3.7,0.8l-4.5,4.3l2.7,5.8l0.2,0.4v0.1
                ...
                L165.325,171.525z"/>
            <path fill="#6b6b6b" class="FR-26" :style="{display:props.displayDep['FR-26']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M184.925,179.125l-3.7-4.1l-9.7-0.9l-0.1,13.6l-1.7,2.6l2.1,19.5l-6.2,2.5l-4,9.7l-0.5,2.4l-7.7-4
            ...
            <path fill="#6b6b6b" class="FR-23" :style="{display:props.displayDep['FR-01']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M199.525,273.325l-6.3,0.8l-4.2,5.3l-13.7,1l2.5,6.3l4.7,4.7l5.4,20.1l-0.3,8.4l2.8,2.1l-10.2,5.1l-2.7-2
            ...
            <path fill="#6b6b6b" class="FR-21" :style="{display:props.displayDep['FR-21']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M245.525,369.925L245.525,369.925l-6.4,6.9l-2.4,5.9l-8.8,6.6l-0.9,6.5l-4.5,6.4l-6.2,0.9l-2.2,2.1h-0.1
            ...
            <path fill="#6b6b6b" class="FR-25" :style="{display:props.displayDep['FR-25']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M284.425,418.625l-0.7,5.6l-1.5,6l-5.1,3.6l0.7,4l-6.9,3.9l-5.1,7.2l-3.9,3.5l3,10.3l-8.5,2.2v3.3l2.8,1.5
            ...
            <path fill="#6b6b6b" class="FR-24" :style="{display:props.displayDep['FR-24']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M297.825,545.725l9.7,4.3l2.5,6l0.2,3.4l-2.5,2.6l2.8,2.8l-1.4,3.3l-3.7,0.7l1,6.5l3.8,1.6l3.7-1.3
            ...
            <path fill="#6b6b6b" class="FR-27" :style="{display:props.displayDep['FR-27']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M553.625,444.225l1.5-6.7l0.3-0.4l2-2.3l4,0.1l-4.3-10.5l-6.8-0.3l-5.8-3.8l-0.9-7.4l-3.1-0.1l-2.6-5.8
            ...
            <path fill="#6b6b6b" class="FR-28" :style="{display:props.displayDep['FR-28']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M567.625,467.725l-7.1-1.4l-6.9-8.3l-6.9,7.7l-2.2,6.1l4.8,9.5l7.8,8.7l-5.8-0.8l-5.9,4.4l1.5,2.9
                ...
                z"/>
            <path fill="#7E6078" class="FR-08" :style="{display:props.displayDep['FR-08']}" @click="onclick($event)" @dblclick="ondblclick()" @mouseenter="onenter($event)" @mouseleave="onleave($event)" d="M561.625,556.825l0.5,19.5l-9.6-1.5l-4,5.5l-12,4.8l-1,3.2l-3.1,0.3l-2.5,3.2l0.4,3.8l-4.4,5.6l-0.6,3.3
