  ...
  >
    ...
    >
      <path
        fill="#6b6b6b"
        class="FR-acad-09"
        :style="{ display: props.displayDep['FR-acad-09'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-11"
        :style="{ display: props.displayDep['FR-acad-11'] }"
        d="M539.125,143.625l6.1,2.8l-1.9,2.8l2.6,1.8l1.6-2.8l3.2,0.5l4.9,3.7l-3.4,15l-2.5,2l-3.9-0.4l2.2,1.5
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-15"
        :style="{ display: props.displayDep['FR-acad-15'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-14"
        :style="{ display: props.displayDep['FR-acad-14'] }"
        d="M408.425,75.025l0.1-0.4l-17.6-4.7l-5.8,2l-2.6-1.9l-2.9,2.5l-14.2,0.7l-3.7-3l-9.6,2l-0.9-3.5l-2.7,1.9
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-10"
        :style="{ display: props.displayDep['FR-acad-10'] }"
        d="M412.925,76.325l0.9,6.4l-1.5,3.9l1.5,3.5l-5.6,8.1l-3.1,0.3l0.3,16l-1.1,3.2l-6-2l-8.9,4.4l-1.4,3l3.6,9
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-16"
        :style="{ display: props.displayDep['FR-acad-16'] }"
        d="M347.325,139.025l-7.7-1.1l0.3,2.3l-2,2.6l-0.1,0.1c-0.7,0.5-1.5,1-2.3,1.6c-1,0.7-2,1.4-3,2.1l-2.9-1.2
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-18"
        :style="{ display: props.displayDep['FR-acad-18'] }"
        d="M339.925,140.225l-0.3-2.3l-12.2-7.2l-2.5,1.9l-10.3-2.5l-7.1,2l-6.3-1.2l-1.8-3.6l-4.5,10.6h-4.2
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-17"
        :style="{ display: props.displayDep['FR-acad-17'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-05"
        :style="{ display: props.displayDep['FR-acad-05'] }"
        d="M448.425,218.225l-3.3-0.4l0.4-3.2l-3-1.1l-0.6-3.1l-3.9-0.8v0.1l-4.3-0.6l-5.3,4.4l-6.9,1l-2.5,2.2
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-04"
        :style="{ display: props.displayDep['FR-acad-04'] }"
        d="M470.125,237.325l3-1.9l2.3,3.5l0.2,3.5l-5.3,4.6l3,1.6l4.3,9.2l-1.3,1.4l-2,9.3l-7,7.6l-1.2,4.5l0.5,3.4
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-07"
        :style="{ display: props.displayDep['FR-acad-07'] }"
        d="M358.225,227.725l1.7-2.7l-1.2-3.3l5.2-5.5l-0.5-6.5l-7.5-8.4l-12.6,3l-10.3-0.8l3-1.7l0.6-3l-4.7-4.8
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-01"
        :style="{ display: props.displayDep['FR-acad-01'] }"
        d="M382.825,305.425l-4.8-4.2l-3.2,2l-7.2-0.2l-6.5-7.1l0,0h-4.5l-5.4,4.1l-9.5,3.3l-2.5,2.1l1.9,6l-1.9,2.7
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-22"
        :style="{ display: props.displayDep['FR-acad-22'] }"
        d="M325.525,321.925L325.525,321.925l-5.5-0.2l-3.1,0.9l-14.8-3l-2.2,2.8l-12.8,1.2l-3.2,3.2l-1.9-2.7
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-03"
        :style="{ display: props.displayDep['FR-acad-03'] }"
        d="M470.225,317.425h-0.1l-5.4-3.6l-6,1.4l-6.6-1.7l-6.6,23.5l-6.5-8.7l-1.8,2.6l-2.7-1.7l-2.6,1.9l-2.4-2
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-02"
        :style="{ display: props.displayDep['FR-acad-02'] }"
        d="M459.325,375.125l-7.8,1.7l-2.8,2.8l2.1,2.8l-5,4.5l0,0l0.2,1.2v5l-5.6,3l-3.6,5.5l-3.9,0.8l-1,4.7v3.5
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-20"
        :style="{ display: props.displayDep['FR-acad-20'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-06"
        :style="{ display: props.displayDep['FR-acad-06'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-26"
        :style="{ display: props.displayDep['FR-acad-26'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-21"
        :style="{ display: props.displayDep['FR-acad-21'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-25"
        :style="{ display: props.displayDep['FR-acad-25'] }"
        d="M284.425,418.625l-0.7,5.6l-1.5,6l-5.1,3.6l0.7,4l-6.9,3.9l-5.1,7.2l-3.9,3.5l3,10.3l-8.5,2.2v3.3l2.8,1.5
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-24"
        :style="{ display: props.displayDep['FR-acad-24'] }"
        d="M297.825,545.725l9.7,4.3l2.5,6l0.2,3.4l-2.5,2.6l2.8,2.8l-1.4,3.3l-3.7,0.7l1,6.5l3.8,1.6l3.7-1.3
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-27"
        :style="{ display: props.displayDep['FR-acad-27'] }"
      ...
      <path
        fill="#6b6b6b"
        class="FR-acad-28"
        :style="{ display: props.displayDep['FR-acad-28'] }"
        d="M567.625,467.725l-7.1-1.4l-6.9-8.3l-6.9,7.7l-2.2,6.1l4.8,9.5l7.8,8.7l-5.8-0.8l-5.9,4.4l1.5,2.9
      ...
      <path
        fill="#7E6078"
        class="FR-acad-08"
        :style="{ display: props.displayDep['FR-acad-08'] }"
