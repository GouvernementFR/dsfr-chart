            ...
            <div class="chart">
                ...
                <div v-for="(item, index) in nameParse" :key="item" class="flex fr-mt-3v fr-mb-1v"
                    ...
                    <span class="legende_dot"
                        v-bind:style="{ 'background-color': colorParse[index], 'opacity': opacity[index] }"
        ...
        getData() {
            ...
            data.forEach(function (dj, j) {
                self.datasets.push({
                    ...
                    pointRadius: 3,
                    pointStyle: 'circle',
                    pointBackgroundColor: 'rgba(212, 130, 242, 1)',
            ...
            this.chart = new Chart(ctx, {
                ...
                },
                {
                    afterDraw: function (chart, args, options) {
                        ...
                        const xMiddle = (xAxis.left + xAxis.right) / 2;
                ...
                options: {
                    ...
                    scales: {
                        xAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: 'Completness of vision '
                            },
                            ticks: {
                                maxTicksLimit: 1,
                                display: false,
