    ...
    $props: {
      handler() {
        ...
        this.datasets.forEach((dataset, i) => {
          ...
          this.chart.data.datasets[i].fill = dataset.fill;
          ...
          this.chart.data.datasets[i].showLine = dataset.showLine;
          this.chart.data.datasets[i].borderWidth = dataset.borderWidth;
